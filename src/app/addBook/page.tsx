...
export default function AddPage() {
  ...
  const handleChoosingBook = (id: string) => {
    if (dataFormated) {
      const choose: BookProps | undefined = dataFormated.find(e => e.id === id)
      console.log("handleChoosing:", choose)
      ...
      {modal && <Modal>
        <div className='flex absolute w-screen bg-olive-light h-screen left-0 top-0 flex-col items-center'>
          ...
          <div className='flex flex-col p-3'>
            ...
            {dataFormated && dataFormated?.map((e) => {
              return <div
                onClick={() => {
                ...
                <span><span className='font-bold'>Category : </span> {e.categories}</span>
