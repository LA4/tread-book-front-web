        ...
        <span {...props} >
            ...
            }
            {
                ...
                <svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="24.6338" y="0.766418" width="35" height="35" rx="17.5" transform="rotate(42.9943 24.6338 0.766418)" fill="#58594D" />
                    <path d="M29.0388 17.4516C29.4908 16.9669 30.2501 16.9403 30.7348 17.3922L32.4903 19.0288C32.975 19.4808 33.0016 20.2401 32.5497 20.7248L21.9116 32.135C21.4597 32.6198 20.7003 32.6464 20.2156 32.1944L18.4602 30.5578C17.9754 30.1059 17.9489 29.3465 18.4008 28.8618L29.0388 17.4516Z" fill="#E0E0D1" />
                    <path d="M32.8169 28.3569C33.3017 28.8089 33.3283 29.5682 32.8763 30.0529L31.2397 31.8083C30.7878 32.2931 30.0284 32.3197 29.5437 31.8677L18.1335 21.2297C17.6488 20.7778 17.6222 20.0184 18.0741 19.5337L19.7107 17.7783C20.1627 17.2935 20.922 17.2669 21.4068 17.7189L32.8169 28.3569Z" fill="#E0E0D1" />
                </svg>
