...
export default function AddBookForm({ data, handleFormData }: FormProps) {
  ...
  return (
    <form
      className="flex gap-4 flex-col w-full p-8"
    ...
    >
      ...
      <div className="flex gap-4 w-full">
        ...
        />
        <input
          className="flex p-1 rounded-t-lg w-1/3"
          placeholder="pages"
          {...register("pages")}
        />
      </div>
      ...
      {openResume ? (
        <div className="flex flex-col">
          <textarea
            placeholder="resume"
            className="flex p-2 h-[300px] rounded-t-lg  border-b-4 border-olive-dark"
            {...register("resume")}
          />
          <span
            onClick={() => {
            ...
            className="bg-olive-dark h-[20px] self-center rounded-b-full items-center justify-center flex p-4"
          >
            {" "}
        ...
        <div className="flex flex-col">
          <textarea
            placeholder="resume"
            className="flex p-2 h-[100px] rounded-t-lg border-b-4 border-olive-dark"
            {...register("resume")}
          />
          <span
            onClick={() => {
      ...
      <input
        ...
        {...register("id")}
      />
      <div className="flex gap-4 h-[35px] mt-8">
        <span
          className="flex w-1/4 bg-olive-light items-center justify-center rounded-full text-white"
          onClick={() => {
            reset();
          }}
        >
